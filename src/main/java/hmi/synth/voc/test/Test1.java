...
public class Test1 {
	...
	public void synthesisWithContinuousFeatureProcessors() throws Exception {
		...
		// String feaFile = "/f0-hsmm-experiment/red_ball.pfeats";
		// String feaFile = "/f0-hsmm-experiment/THAT_ball.pfeats";
		// String feaFile = "/f0-hsmm-experiment/RED_ball.pfeats";
		// String feaFile = "/f0-hsmm-experiment/red_BALL.pfeats";
		String feaFile = "/f0-hsmm-experiment/THAT_BALL.pfeats";
		//
		// String feaFile = "/f0-hsmm-experiment/us1-mbrola.pfeats";
		// String feaFile = "/f0-hsmm-experiment/cmu-slt-unit-selection.pfeats";
		// String feaFile = "/f0-hsmm-experiment/welcome.pfeats";
		// String feaFile = "/f0-hsmm-experiment/canadian.pfeats";
		...
		try {
			...
			/* the generated parameters will be saved in tmp.mfc and tmp.f0, including header. */
	...
	public void synthesisWithProsodySpecificationInExternalFiles() throws Exception {
		...
		// external duration obtained , there is a problem with this because it does not have an initial sil
		// String labFile = "/f0-hsmm-experiment/cmu_us_arctic_slt_a0001.realised_durations";
	...
	public void generateParameters() throws IOException, InterruptedException, Exception {
		...
		try {
			...
			while (filesScanner.hasNext()) {
				...
				durStateFile = outputDir + file + ".slab"; /* state level realized durations */
...
//
//		String inFile = "/quality-control-experiment/slt/cmu_us_arctic_slt_a0001.wav";
//		String outFile = "/quality-control-experiment/slt/cmu_us_arctic_slt_a0001.lf0";
//		String tmpFile = "/quality-control-experiment/slt/tmp.mfc";
//		String tmpRawFile = "/quality-control-experiment/slt/tmp.raw";

...
public class PosAnnotator implements Annotator {
	...
	/*
	 * assumes sm.text is ready to be processed. this means utf-8 double returns for paragraphs. 
	 * no html if possible... entities expanded please!
	 * returns a SpeechMarkup instance w/ sentences each with a single phrase of words
	 * words have pos
	 */
